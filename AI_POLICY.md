...
AI-assisted development is welcome in hull.
...
A contribution is judged as a contribution to hull, not as AI output.
...
## AI does not relax hull's engineering rules
...
hull may be developed using interactive assistants as well as autonomous or unattended agents.
...
We welcome research involving hull and AI-assisted software engineering, including:
...
If an experiment produces a genuinely useful improvement to hull, we welcome it as a contribution.
