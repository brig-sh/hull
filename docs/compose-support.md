...
**Phase 2 — networking via a user-mode gateway (implemented):** each service's single NIC
...
init-wrapper config) was replaced by this design.
...
**Phase 4 — exit status, one-shot services, restart policies (implemented):** `InstanceState`
