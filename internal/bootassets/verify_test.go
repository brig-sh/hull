...
// for "there is no signature here" and for "this signature is wrong", and only
// the second is evidence of anything. Reading the difference off cosign's own
// message is what lets the second fail closed without an older, unsigned
// bundle taking the same treatment.
