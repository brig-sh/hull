...
// docs/checkpoint-restore.md:42-49 and vz-runner/Sources/main.swift:1059-1067.
...
// docs/checkpoint-restore.md:49 -- "| `latest.json`| manifest, written last;
...
// freshness half of docs/checkpoint-restore.md:49 ("its mtime marks checkpoint
...
// block-rootfs requirement exists to prevent (docs/checkpoint-restore.md:51-53).
...
// written last (docs/checkpoint-restore.md:49), so a directory holding
