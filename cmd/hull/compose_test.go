...
// mustContain / mustNotContain mirror the conformance suite's helpers for
...
// volume, healthcheck test prefix) is asserted black-box by the conformance
...
// independent of the conformance suite (whose equivalent case,
// spec.interpolation, is out of scope for this branch's frozen
// test/conformance package).
...
// TestComposeConfigHydratesImpliedOneShot mirrors the conformance suite's
