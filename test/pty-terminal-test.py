...
# pull) and when each boot marker first showed up. Intervals from that line
# include the VMM's own startup and firmware, not just the kernel. The
# numbers are what README quotes for boot time, so they come from here
# instead of by hand.
