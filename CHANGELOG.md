...
- Record the open-ingest threat model in ADR 0008
- ADR 0008 and canonical schema for usage/crash telemetry
...
- Measured conformance delta for the exec-support experiment
- Add ADR-0007 exit status, one-shot services, restart policies
- Add ADR-0006 compose named volumes
- Add ADR-0005 compose interpolation and env_file
- Correct stale no-exec-facility claims
- Add ADR-0004 exec-support experiment branch
- Add ADR-0003 out-of-scope compose capabilities
- Point README at the compose conformance report
- Add ADR-0002 compose-spec conformance suite
...
- Generate compose-conformance report + CI gates
...
- Prove ADR-0007 exit status, jobs, restart policies
- Drive the real stop path, not just the helper
- Add out-of-scope status and re-base the headline score
- Add runtime-tier conformance suite
- Add static-tier conformance harness
...
- ADR 0001 single-NIC gateway; merge networking phases
