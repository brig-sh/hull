...
[`docs/compose-conformance.md`](docs/compose-conformance.md) (generated from
the manifest in `test/conformance/`; ADR
[0002](docs/adr/0002-compose-conformance-suite.md)).
...
- macOS 26+ (Tahoe) on Apple Silicon (M1/M2/M3/M4/M5)
- Go 1.26+ (see `go.mod`)
